...
function AdminArchivesPage() {
  ...
  // 2) Filtre "passé" (page Archives = uniquement les créneaux terminés)
  const now = new Date();
  ...
  return (
    <div className="sr-page">
      <div className="sr-page-header">
        <div>
          <h2 className="sr-page-title">Archives</h2>
      ...
      <div className="sr-page-body">
        <div className="sr-card">
          ...
          {!loading && !error && totalReservations === 0 && (
            <p>Aucune réservation passée ne correspond à ta recherche.</p>
          )}
